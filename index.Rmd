...
plot1 = ggplot(data_plot) +
  ...
  annotate(geom = "text", x = as.Date("2020-06-10")+2, y = max(data_plot$new_cases, na.rm=T)-75, label = "RMCO", angle = 90) +
...
plot2 = ggplot(data_plot) +
  ...
  geom_vline(xintercept = as.numeric(as.Date("2020-06-10")), linetype = "dotted") +
  annotate(geom = "text", x = as.Date("2020-06-10")+2, y = max(data_plot$total_cases, na.rm=T)-75, label = "RMCO", angle = 90) +
...
plot3 = ggplot(data_plot1) +
  ...
  geom_vline(xintercept = as.numeric(as.Date("2020-06-10")), linetype = "dotted") +
  annotate(geom = "text", x = as.Date("2020-06-10")+2, y = max(data_plot1$new_deaths, na.rm=T)+30, label = "RMCO", angle = 90) +
...
plot4 = ggplot(data_plot1) +
  ...
  geom_vline(xintercept = as.numeric(as.Date("2020-06-10")), linetype = "dotted") +
  annotate(geom = "text", x = as.Date("2020-06-10")+2, y = max(data_plot1$total_deaths, na.rm=T)+30, label = "RMCO", angle = 90) +
