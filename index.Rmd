...
sel_date_state = max(covid_my_state$date)
...
### **Sources:** Ministry of Health Malaysia and Department of Statistics Malaysia. {.value-box}
```{r}
valueBox(
  value = "",
)
...
plot5 = ggplot(data = data_plots) +
  ...
  scale_x_date(date_breaks = "84 day", date_labels = "%d/%m/%y", limits = c(min(data_plots$date), NA)) +
  scale_y_continuous(labels = label_comma()) +
